...
const rules = {
  name: {
    ...
    minLength: helpers.withMessage("NAME MUST HAVE AT LEAST 2 LETTERS", minLength(2)),
  ...
  phone: {
    required: helpers.withMessage("PLEASE PROVIDE A VALID PHONE NUMBER", isMobilePhone)
  },
  email: {
  ...
  ccNumber: {
    required: helpers.withMessage("PLEASE PROVIDE A VALID CREDIT CARD NUMBER", isCreditCard)
  },
  ccExpiryMonth: {},
  ccExpiryYear: {},
}
      ...
      <form @submit.prevent="submitOrder">
        ...
        <div id='checkout-totals' v-if='!cartStore.cart.empty' >
          <ul>
            ...
            <li>({{asDollarsAndCents(cartStore.cart.subtotal)}} + {{asDollarsAndCents(cartStore.cart.surcharge)}} surcharge)</li>
          </ul>
        </div>
