...
public class ApiResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public List<Book> booksByCategoryId(
            @PathParam("category-id") long categoryId,
            @Context HttpServletRequest httpRequest) {
        try {
            ...
            throw new ApiException(String.format("Book lookup by category id %d failed", categoryId), e);
        }
    }
    ...
    public List<Book> suggestedBooks(
        ...
        try {
            ...
            throw new ApiException("Product lookup via category id failed", e);
        }
    }
    ...
    public List<Book> booksByCategoryName(
        ...
        try {
            ...
            if (category == null) {
                throw new ApiException(String.format("No such book or category: %s", categoryName));
            }
            return bookDao.findByCategoryId(category.categoryId());
        } catch (Exception e) {
    ...
    public List<Book> suggestedBooksByCategoryName(
        ...
        try {
            ...
            throw new ApiException(String.format("Products lookup by categoryName %s failed", categoryName), e);
        }
    }
