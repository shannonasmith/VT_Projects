...
public class ListStackTest {
    private boundedstack.Stack<String> stack_empty_3; // empty stack with capacity of 3
    private boundedstack.Stack<String> stack_ABC_6; // stack with elements:
    // A (bottom of stack), B (middle of stack), and C (top of stack), w/capacity of 6
    private boundedstack.Stack<String> stack_ABC_4;

    @Before
    public void setUp() {
        stack_empty_3 = new boundedstack.ListStack<>(3);
        stack_ABC_6 = new boundedstack.ListStack<>(6);
        ...
        /////////////////
        stack_ABC_4 = new boundedstack.ListStack<>(4);
        stack_ABC_4.push("A"); // this = [A]:4 --> A at top of stack
        stack_ABC_4.push("B"); // this = [A, B]:4 --> B at top of stack, A at bottom
        stack_ABC_4.push("C"); // this = [A, B, C]:4 --> C at top of stack, B in middle, A at bottom
    }
    ...
    public void testInitialStacks() {
        ...
        ///////////////
        assertEquals(4, stack_ABC_4.capacity()); // testing push method
        System.out.println("array:  Expected: 4   Actual: " + stack_ABC_4.capacity());
        assertEquals(3, stack_ABC_4.depth()); // testing push method
        System.out.println("array:  Expected: 3   Actual: " + stack_ABC_4.depth());
        System.out.println("array:  Expected: 4   Actual: " + stack_ABC_4.capacity());
        System.out.println("Actual: " + stack_ABC_4.toString());
    }
    ...
    public void testABC6PushA() {
        ...
        System.out.println("Actual: " + stack_ABC_6.toString());
    }
    ...
    public void testABC6EqualsNull() {
        boundedstack.Stack<String> s = null;
    ...
    public void testABC6EqualsDifferentABC6() {
        boundedstack.Stack<String> stack_ABC_6_dup = new boundedstack.ListStack<>(6);
    ...
    public void testABC6EqualsABC10() {
        boundedstack.Stack<String> stack_ABC_10 = new boundedstack.ListStack<>(10);
        stack_ABC_10.push("A");
        stack_ABC_10.push("B");
        stack_ABC_10.push("C");
    ...
    public void testABC6EqualsAB6() {
        boundedstack.Stack<String> stack_AB_6 = new boundedstack.ListStack<>(10);
        stack_AB_6.push("A");
        stack_AB_6.push("B");
    ...
    public void testEmpty3EqualsDifferentEmpty3() {
        boundedstack.Stack<String> stack_empty_3_dup = new boundedstack.ListStack<>(3);
    ...
    public void testEmpty3EqualsEmpty5() {
        boundedstack.Stack<String> stack_empty_5 = new boundedstack.ListStack<>(5);
    ...
    public void testABC6EqualsDEF6() {
        boundedstack.Stack<String> stack_DEF_6 = new boundedstack.ListStack<>(6);
        stack_DEF_6.push("D");
        stack_DEF_6.push("E");
        stack_DEF_6.push("F");
    ...
    public void testEmpty3NewInstance() {
        boundedstack.Stack<String> newStack = stack_empty_3.newInstance();
    ...
    public void testABC6NewInstance() {
        boundedstack.Stack<String> newStack = stack_ABC_6.newInstance();
        assertEquals(0, newStack.depth());
    ...
    public void testEmpty3Copy() {
        boundedstack.Stack<String> copy = stack_empty_3.copy();
    ...
    public void testABC6Copy() {
        boundedstack.Stack<String> copy = stack_ABC_6.copy();
    ...
    public void testABC6EqualsDifferentABC10() {
        boundedstack.Stack<String> stack_ABC_10_dup = new boundedstack.ListStack<>(10);
...
/*
    TODO Once we have ArrayStack, make this test available
